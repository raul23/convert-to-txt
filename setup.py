"""setup.py file for the ``convert_to_txt`` package.
"""
import fnmatch
import os
import sys
...
from convert_to_txt import __version__, __test_version__
...
setup(name='convert-to-txt',
      version=VERSION,
      description='''Convert documents (pdf, djvu, epub, word) to txt.''',
      ...
      keywords='calibre catdoc convert djvu djvutxt epub msword pdf pdftotext script textutil',
      url='https://github.com/raul23/convert-to-txt',
      author='Raul C.',
      ...
      entry_points={
        'console_scripts': ['convert_to_txt=convert_to_txt.scripts.convert_to_txt:main']
      },
      project_urls={  # Optional
          'Bug Reports': 'https://github.com/raul23/convert-to-txt/issues',
          'Source': 'https://github.com/raul23/convert-to-txt',
      },
      zip_safe=False)
